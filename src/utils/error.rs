...
impl ResponseError for AppError {
    fn error_response(&self) -> HttpResponse {
        let (status_code, error_type) = match self {
            ...
            AppError::AmbiguousSongName(_) => (
                actix_web::http::StatusCode::BAD_REQUEST,
                "ambiguous_song_name",
            ),
            AppError::UserBindingNotFound(_) => (
                actix_web::http::StatusCode::NOT_FOUND,
                "user_binding_not_found",
            ),
            AppError::UserNotFound(_) => (actix_web::http::StatusCode::NOT_FOUND, "user_not_found"),
            AppError::BindingAlreadyExists(_) => (
                actix_web::http::StatusCode::CONFLICT,
                "binding_already_exists",
            ),
            AppError::ProfileVerificationFailed(_) => (
                actix_web::http::StatusCode::BAD_REQUEST,
                "profile_verification_failed",
            ),
            AppError::TokenVerificationFailed(_) => (
                actix_web::http::StatusCode::UNAUTHORIZED,
            ...
            AppError::DatabaseError(_) | AppError::DbError(_) => (
                actix_web::http::StatusCode::INTERNAL_SERVER_ERROR,
                "database_error",
            ),
